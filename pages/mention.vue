<template>
    <div class="mention-legal">
        ...
        <p>
            ...
            ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la
            ...
            consulter le site : <a href="https://www.cnil.fr/">https://www.cnil.fr/</a>
        </p>
        ...
        <p>
           <u>1.2 Éditeur (ci-après « l'éditeur ») :</u>
            L'entreprise individuelle Veron
            située : 14 rue saint Mathieu, 69330
            immatriculée au RCS de Lyon
            n° de téléphone : 0954916676
            adresse mail : veron.appl@hotmail.com
        </p>

        <p>
            <u>1.3 Hébergeur (ci-après « l'hébergeur ») :</u>
            Veron-app.com est hébergé par google, dont le siège social est situé 14 rue saint mathieu 69330.
        </p>

        <p>
           <u>1.4 Délégué à la protection des données (DPO) :</u>
        ...
        <p>
            ...
            fonctionner ce site et plus généralement tous les éléments reproduits ou utilisés sur le site sont protégés par
        ...
        <p>
            ...
            Si l'éditeur venait à faire l'objet d'une procédure amiable ou judiciaire en raison de votre utilisation du site,
        ...
        <p>
            Vos données sont collectées par l'entreprise individuelle Veron.
        ...
        <p>
            ...
            données ;
            le droit à la limitation du traitement : les utilisateurs peuvent de demander à la Plateforme de limiter
            ...
            14 rue saint Mathieu 69330.
            Ou par email, à l’adresse :
            veron.appl@hotmail.com
            Vous pouvez aussi vous adresser à notre délégué à la protection des données : l’OFII, dpo@ofii.fr., qui est à
            votre disposition pour toute question relative à la protection de vos données personnelles.
            ...
            https://www.cnil.fr.
            Nous vous recommandons de nous contacter dans un premier temps avant de déposer une réclamation
        ...
        <p>
            ...
            électronique, de l'installation ou de l'utilisation d'un logiciel ou d'une application mobile et ce, quel que soit
            le type de terminal utilisé (source : https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi).
            ...
            prospect devra accepter ou refuser l’utilisation desdits « cookies ». Le consentement donné sera valable
            pour une période de treize (13) mois. L'utilisateur a la possibilité de désactiver les cookies à tout moment.
            ...
            ;
            - Google Adsense : régie publicitaire de Google utilisant les sites web ou les vidéos YouTube comme
